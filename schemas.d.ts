...
export interface ApiArticleArticle extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    banner: MediaAttribute & RequiredAttribute;
...
export interface BannerGallery extends ComponentSchema {
  info: {
    displayName: 'gallery';
    icon: 'photo-video';
    description: '';
  ...
  attributes: {
    ...
    pictures: MediaAttribute;
  };
}

export interface ContentTextBlock extends ComponentSchema {
  info: {
